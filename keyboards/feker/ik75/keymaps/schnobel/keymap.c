...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT(
                ...
                KC_LCTL,    KC_LGUI,    KC_LALT,                                             KC_SPC,                                KC_RALT,     LT(_FN, KC_APP),   KC_RCTL,                 TD(T_LE),     KC_DOWN,     TD(T_RI)
            ),
	[_FN] = LAYOUT(
                ...
                _______,                C(G(KC_Z)),   _______,     _______,     SCHN_M0,     _______,     _______,     _______,     _______,     _______,           _______,                 _______,      RGB_HUI,     RGB_TOG,
